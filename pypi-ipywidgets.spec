...
Source0  : https://files.pythonhosted.org/packages/35/6f/b741345f3d952d4af42ca111ba49df6d5ed3445c450c34cf80616923c12f/ipywidgets-8.0.3.tar.gz
...
%prep
%setup -q -n ipywidgets-8.0.3
cd %{_builddir}/ipywidgets-8.0.3
pushd ..
cp -a ipywidgets-8.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670497118
