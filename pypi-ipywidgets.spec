...
Version  : 8.1.3
Release  : 92
URL      : https://files.pythonhosted.org/packages/77/0a/7e2069d2cf55307b37a6a5195e873968dea965252976c32515d4e300efb0/ipywidgets-8.1.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/77/0a/7e2069d2cf55307b37a6a5195e873968dea965252976c32515d4e300efb0/ipywidgets-8.1.3.tar.gz
...
%prep
%setup -q -n ipywidgets-8.1.3
cd %{_builddir}/ipywidgets-8.1.3
pushd ..
cp -a ipywidgets-8.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716907870
