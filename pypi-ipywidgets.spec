...
Version  : 8.1.7
Release  : 98
URL      : https://files.pythonhosted.org/packages/3e/48/d3dbac45c2814cb73812f98dd6b38bbcc957a4e7bb31d6ea9c03bf94ed87/ipywidgets-8.1.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/3e/48/d3dbac45c2814cb73812f98dd6b38bbcc957a4e7bb31d6ea9c03bf94ed87/ipywidgets-8.1.7.tar.gz
...
%prep
%setup -q -n ipywidgets-8.1.7
cd %{_builddir}/ipywidgets-8.1.7
pushd ..
cp -a ipywidgets-8.1.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746454495
