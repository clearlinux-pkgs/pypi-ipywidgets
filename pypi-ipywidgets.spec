...
Source0  : https://files.pythonhosted.org/packages/bd/c6/2a746b6a339c17d81fa40f17f74d13d732ffdc3cca65340ecfdf1eee675c/ipywidgets-8.1.2.tar.gz
...
%prep
%setup -q -n ipywidgets-8.1.2
cd %{_builddir}/ipywidgets-8.1.2
pushd ..
cp -a ipywidgets-8.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707498771
