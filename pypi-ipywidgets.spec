...
Provides: ipywidgets
Provides: ipywidgets-python
Provides: ipywidgets-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641446525
...
cp %{_builddir}/ipywidgets-7.6.5/LICENSE %{buildroot}/usr/share/package-licenses/pypi-ipywidgets/5dc7e0ef3878c3d4a92a7233208e6f91553de266
